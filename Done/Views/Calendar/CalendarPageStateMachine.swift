...
struct CalendarPageStateMachine {
    ...
    /// clamp的意思是“夹紧”或“限制”，用于将一个值限制在指定的范围内。
    /// 比如 clamp(5, 1, 10) 会返回 5，因为 5 在范围 [1, 10] 内；
    /// clamp(-3, 0, 10) 会返回 0，因为 -3 小于范围的下界 0；
    /// clamp(15, 0, 10) 会返回 10，因为 15 大于范围的上界 10。
}
